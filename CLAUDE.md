...
This project is indexed by GitNexus as **PresenceMap** (1838 symbols, 3008 relationships, 115 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
