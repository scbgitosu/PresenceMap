...
This project is indexed by GitNexus as **PresenceMap** (1693 symbols, 2732 relationships, 95 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
